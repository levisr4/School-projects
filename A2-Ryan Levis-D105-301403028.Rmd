...
#P(X ≤ 112) = P(Z≤ (112-wmean)/sdwage)
z_score<- (wmean-112) / sdwage
z_score
#But this is for x<112, we need to re-arrange it for x>112, which is just 1- P(z<0.0071)
#To find the area above 0.007102846, first we will find the area below 0.007102846.Using the standard normal table to find the area below 0.007102846. We conclude that the area below p(z<0.007102846) = 0.504, so, 1 - 0.504 = 0.496
